...
- [x] 06-02-PLAN.md — Guest CRUD API: add / rename / move / cascade-delete handlers via service-role [Wave 2]
- [x] 06-03-PLAN.md — Households view: grouped Server Component + inline-edit client island [Wave 3]
- [x] 06-04-PLAN.md — RSVP view + meal-count summary + two CSV exports [Wave 2]
...
| 6. Admin Console | 4/5 | In Progress|  |
